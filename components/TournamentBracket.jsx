...
const TournamentBracket = () => {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {participants.map((participant, index) => (
                <div key={index} className="flex mb-2">
                  <input
                    ...
                    className="flex-grow px-3 py-2 rounded-l-md bg-gray-700 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-purple-500"
                    placeholder={`Participant ${index + 1}`}
                  />
                  <button
                    type="button"
                    onClick={() => handleRemoveParticipant(index)}
                    className="px-4 py-2 bg-red-600 text-white rounded-r-md hover:bg-red-700 transition duration-200"
                  >
                    Remove
                  </button>
                </div>
              ...
              <button
                ...
                className="mt-2 w-full px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-200"
              >
                Add Participant
              </button>
            </div>
  ...
  return (
    <div className="p-6 bg-gray-900 text-gray-100 overflow-x-auto">
      ...
      >
        {isSaving ? "Saving..." : "Save Bracket as Image"}
      </button>
    </div>
  );
};
