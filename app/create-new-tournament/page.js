            ...
            <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center">
                            <div className="w-full lg:max-w-md mb-6 lg:mb-0">
                                <div className="flex items-center mb-2">
                                    ...
                                    <div className="text-xs text-gray-500 ml-2">(maximum 30 characters)</div>
                                </div>
                                <input
                                    type="text"
                ...
                <section>
                    ...
                    <div className="p-5">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                                {platforms.map(platform => (
                                    <button
                                        type="button"
                                        key={platform}
                                        className={`p-4 rounded-md ${selectedPlatform === platform
                                            ? "bg-blue-600"
                        ...
                        <div className='mt-2'>
                            <p className='text-xs font-mono'>Want to organize a big tournament with more than 128 Participants? Check the plans on the pricing page.</p>
                        </div>
                        <div className='mt-4'>
